...
#  read_ddc ../design_data/cpu_pad.ddc
...
derive_pg_connection -create_net;# first create P/G net s defined in UPF FILE
...
read_sdc $ICC_INPUTS_PATH/cpu_pad.sdc
check_timing
