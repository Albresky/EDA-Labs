...
write -hierarchy -f ddc -out unmapped/100KHz/cpu_pad.ddc
list designs
list_libs
...
create_clock -period  [get_ports clock]
...
report_constraint > ./rpt/100KHz/rpt_consitraints
report_timing > ./rpt/100KHz/rpt_timing
report_area > ./rpt/100KHz/rpt_area
report_power > ./rpt/100KHz/rpt_power

write -hierarchy -format ddc -output ./mapped/100KHz/cpu_pad.ddc
write -hierarchy -format verilog -output ./mapped/100KHz/cpu_pad.v
write_sdc ./mapped/100KHz/cpu_pad.sdc
write_sdf ./mapped/100KHz/cpu_pad.sdf
